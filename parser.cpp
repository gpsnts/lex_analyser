...
#line 153 "parser.cpp"
  ...
  /// Build a parser object.
   Parser :: Parser  (LexTrabParser::Scanner &scanner_yyarg, LexTrabParser::Interpreter &driver_yyarg)
#if YYDEBUG
    : yydebug_ (false),
      yycdebug_ (&std::cerr),
#else
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_command: // command
        value.YY_MOVE_OR_COPY<  LexTrabParser::Command  > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s, YY_MOVE (that.location))
  {
    ...
    {
      case symbol_kind::S_command: // command
        value.move<  LexTrabParser::Command  > (YY_MOVE (that.value));
        break;
   ...
   Parser ::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    {
      case symbol_kind::S_command: // command
        value.copy<  LexTrabParser::Command  > (that.value);
        break;
   ...
   Parser ::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    {
      case symbol_kind::S_command: // command
        value.move<  LexTrabParser::Command  > (that.value);
        break;
  ...
  yyreduce:
    ...
    {
      case symbol_kind::S_command: // command
        yylhs.value.emplace<  LexTrabParser::Command  > ();
        break;
...
#line 80 "parser.y"
            {
                const Command &cmd = yystack_[0].value.as <  LexTrabParser::Command  > ();
...
#line 95 "parser.y"
        {
            ...
            cout << "ID: " << id << endl;
            yylhs.value.as <  LexTrabParser::Command  > () = Command(id);
        }
#line 670 "parser.cpp"
    break;
...
#line 101 "parser.y"
        {
            ...
            yylhs.value.as <  LexTrabParser::Command  > () = Command(id, args);
        }
#line 681 "parser.cpp"
    break;
